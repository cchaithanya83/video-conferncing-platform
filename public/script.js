...
const meetingId = urlParams.get('meetingid'); // Replace 'meetingId' with the actual query parameter name

// Check if the meetingId exists in the URL
if (meetingId) {
  // Store the meetingId in session storage
  sessionStorage.setItem('meetingId', meetingId);
  console.log('Meeting ID stored:', meetingId);
} else {
